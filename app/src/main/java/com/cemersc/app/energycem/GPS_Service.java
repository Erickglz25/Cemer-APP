...
public class GPS_Service extends Service {
    ...
    public void onCreate() {
        ...
        listener = new LocationListener() {
            @Override
            public void onLocationChanged(Location location) {//cada vez que las coordenadas cambian
                //se llama este metodo, se genera un nuevo intent, co el filtro location_update
